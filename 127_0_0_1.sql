...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 29 Jul 2023 pada 06.43
...
-- Database: `appbuku`
--
CREATE DATABASE IF NOT EXISTS `appbuku` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `appbuku`;
...
INSERT INTO `databuku` (`id`, `judul`, `penulis`, `genre`) VALUES
(1, 'Harry Potter', 'J.K. Rowling', 'Misteri'),
(2, 'Sherlock Holmes', 'Arthur Conan Doyle', 'Misteri'),
(3, 'Marmut Merah Jambu', 'Raditya Dika', 'Komedi'),
(10, 'a', 'a', 'Romance');
...
-- Database: `dml_pt2`
--
CREATE DATABASE IF NOT EXISTS `dml_pt2` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `dml_pt2`;
...
-- Database: `eleanor`
--
CREATE DATABASE IF NOT EXISTS `eleanor` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `eleanor`;
...
CREATE TABLE `film` (
  ...
  `deskripsi_film` varchar(100) DEFAULT NULL,
  `id_jam_tayang` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `film` (`id_film`, `nama_film`, `deskripsi_film`, `id_jam_tayang`) VALUES
(1, 'Spiderman', 'Stringy stringy', NULL),
(2, 'Korek Api the movie', 'Stringy stringy', NULL),
(3, 'Balada sang pencuri korek api', '', NULL),
(4, 'Smoke on the lenovo', 'Stringy stringy', NULL);
...
INSERT INTO `jam_tayang` (`id_jam_tayang`, `pagi`, `siang`, `malam`) VALUES
(1, 1, NULL, NULL),
(2, NULL, 1, NULL);
...
INSERT INTO `reservasi` (`id_reservasi`, `jumlah_reservasi`, `id_studio`, `id_user`, `id_tanggal`, `id_film`) VALUES
(1, 1, 1, 1, 1, 1),
(2, 1, 2, 2, 2, 2);
...
--
DELIMITER $$
CREATE TRIGGER `reservasi berhasil` AFTER UPDATE ON `reservasi` FOR EACH ROW UPDATE `studio` SET `jumlah_seat`= 2 WHERE 1
$$
DELIMITER ;
...
CREATE TABLE `studio` (
  ...
  `nama_studio` varchar(30) DEFAULT NULL,
...
INSERT INTO `studio` (`id_studio`, `nama_studio`, `jumlah_seat`) VALUES
(1, 'Studio 1 - Evermount', 59),
(2, 'Studio 2 - Trickstar', 55),
(3, 'Studio 3 - Geneva', 1);
...
INSERT INTO `tanggal` (`id_tanggal`, `tanggal_pesan`) VALUES
(1, '2001-02-03'),
(2, '2004-05-06');
...
INSERT INTO `transaksi` (`id_transaksi`, `id_reservasi`) VALUES
(1, 1),
(2, 2);
...
ALTER TABLE `film`
  ...
  ADD UNIQUE KEY `id_jam_tayang` (`id_jam_tayang`);

--
-- Indeks untuk tabel `jam_tayang`
--
...
ALTER TABLE `reservasi`
  ...
  ADD UNIQUE KEY `id_tanggal` (`id_tanggal`),
...
--
ALTER TABLE `studio`
  MODIFY `id_studio` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `film`
  ADD CONSTRAINT `film_ibfk_1` FOREIGN KEY (`id_jam_tayang`) REFERENCES `jam_tayang` (`id_jam_tayang`);

--
-- Ketidakleluasaan untuk tabel `reservasi`
--
ALTER TABLE `reservasi`
  ADD CONSTRAINT `reservasi_ibfk_1` FOREIGN KEY (`id_studio`) REFERENCES `studio` (`id_studio`) ON DELETE NO ACTION,
  ADD CONSTRAINT `reservasi_ibfk_2` FOREIGN KEY (`id_user`) REFERENCES `user` (`id_user`) ON DELETE NO ACTION,
  ADD CONSTRAINT `reservasi_ibfk_4` FOREIGN KEY (`id_tanggal`) REFERENCES `tanggal` (`id_tanggal`) ON DELETE NO ACTION,
  ADD CONSTRAINT `reservasi_ibfk_5` FOREIGN KEY (`id_film`) REFERENCES `film` (`id_film`) ON DELETE NO ACTION;
...
--
CREATE DATABASE IF NOT EXISTS `gadgetstoreid` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `gadgetstoreid`;
...
--
-- Stand-in struktur untuk tampilan `emp_details_view`
...
-- Database: `soal_a`
--
CREATE DATABASE IF NOT EXISTS `soal_a` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `soal_a`;

-- --------------------------------------------------------

--
-- Struktur dari tabel `dipamerkan`
--
-- Kesalahan membaca struktur untuk tabel soal_a.dipamerkan: #1932 - Table &#039;soal_a.dipamerkan&#039; doesn&#039;t exist in engine
-- Kesalahan membaca data untuk tabel soal_a.dipamerkan: #1064 - You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near &#039;FROM `soal_a`.`dipamerkan`&#039; at line 1
...
--
-- Kesalahan membaca struktur untuk tabel soal_a.donatur: #1932 - Table &#039;soal_a.donatur&#039; doesn&#039;t exist in engine
-- Kesalahan membaca data untuk tabel soal_a.donatur: #1064 - You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near &#039;FROM `soal_a`.`donatur`&#039; at line 1
...
--
-- Kesalahan membaca struktur untuk tabel soal_a.kontak: #1932 - Table &#039;soal_a.kontak&#039; doesn&#039;t exist in engine
-- Kesalahan membaca data untuk tabel soal_a.kontak: #1064 - You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near &#039;FROM `soal_a`.`kontak`&#039; at line 1
...
--
-- Kesalahan membaca struktur untuk tabel soal_a.pameran: #1932 - Table &#039;soal_a.pameran&#039; doesn&#039;t exist in engine
-- Kesalahan membaca data untuk tabel soal_a.pameran: #1064 - You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near &#039;FROM `soal_a`.`pameran`&#039; at line 1

-- --------------------------------------------------------

--
-- Struktur dari tabel `patung`
--
-- Kesalahan membaca struktur untuk tabel soal_a.patung: #1932 - Table &#039;soal_a.patung&#039; doesn&#039;t exist in engine
-- Kesalahan membaca data untuk tabel soal_a.patung: #1064 - You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near &#039;FROM `soal_a`.`patung`&#039; at line 1
...
--
-- Kesalahan membaca struktur untuk tabel soal_a.seniman: #1932 - Table &#039;soal_a.seniman&#039; doesn&#039;t exist in engine
-- Kesalahan membaca data untuk tabel soal_a.seniman: #1064 - You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near &#039;FROM `soal_a`.`seniman`&#039; at line 1
--
-- Database: `soal_b`
--
CREATE DATABASE IF NOT EXISTS `soal_b` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `soal_b`;

-- --------------------------------------------------------

--
-- Struktur dari tabel `cucimobil`
--
-- Kesalahan membaca struktur untuk tabel soal_b.cucimobil: #1932 - Table &#039;soal_b.cucimobil&#039; doesn&#039;t exist in engine
-- Kesalahan membaca data untuk tabel soal_b.cucimobil: #1064 - You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near &#039;FROM `soal_b`.`cucimobil`&#039; at line 1
...
--
-- Kesalahan membaca struktur untuk tabel soal_b.kendaraan: #1932 - Table &#039;soal_b.kendaraan&#039; doesn&#039;t exist in engine
-- Kesalahan membaca data untuk tabel soal_b.kendaraan: #1064 - You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near &#039;FROM `soal_b`.`kendaraan`&#039; at line 1
...
--
-- Kesalahan membaca struktur untuk tabel soal_b.kepemilikan: #1932 - Table &#039;soal_b.kepemilikan&#039; doesn&#039;t exist in engine
-- Kesalahan membaca data untuk tabel soal_b.kepemilikan: #1064 - You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near &#039;FROM `soal_b`.`kepemilikan`&#039; at line 1
...
-- Struktur dari tabel `kontak`
--
-- Kesalahan membaca struktur untuk tabel soal_b.kontak: #1932 - Table &#039;soal_b.kontak&#039; doesn&#039;t exist in engine
-- Kesalahan membaca data untuk tabel soal_b.kontak: #1064 - You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near &#039;FROM `soal_b`.`kontak`&#039; at line 1
...
--
-- Kesalahan membaca struktur untuk tabel soal_b.layanan: #1932 - Table &#039;soal_b.layanan&#039; doesn&#039;t exist in engine
-- Kesalahan membaca data untuk tabel soal_b.layanan: #1064 - You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near &#039;FROM `soal_b`.`layanan`&#039; at line 1
...
--
-- Kesalahan membaca struktur untuk tabel soal_b.member: #1932 - Table &#039;soal_b.member&#039; doesn&#039;t exist in engine
-- Kesalahan membaca data untuk tabel soal_b.member: #1064 - You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near &#039;FROM `soal_b`.`member`&#039; at line 1
...
--
-- Kesalahan membaca struktur untuk tabel soal_b.mencuci: #1932 - Table &#039;soal_b.mencuci&#039; doesn&#039;t exist in engine
-- Kesalahan membaca data untuk tabel soal_b.mencuci: #1064 - You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near &#039;FROM `soal_b`.`mencuci`&#039; at line 1
...
--
-- Kesalahan membaca struktur untuk tabel soal_b.petugas: #1932 - Table &#039;soal_b.petugas&#039; doesn&#039;t exist in engine
-- Kesalahan membaca data untuk tabel soal_b.petugas: #1064 - You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near &#039;FROM `soal_b`.`petugas`&#039; at line 1
--
-- Database: `test`
--
...
--
-- Kesalahan membaca struktur untuk tabel test.kantor: #1932 - Table &#039;test.kantor&#039; doesn&#039;t exist in engine
-- Kesalahan membaca data untuk tabel test.kantor: #1064 - You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near &#039;FROM `test`.`kantor`&#039; at line 1
...
--
-- Kesalahan membaca struktur untuk tabel test.pekerja: #1932 - Table &#039;test.pekerja&#039; doesn&#039;t exist in engine
-- Kesalahan membaca data untuk tabel test.pekerja: #1064 - You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near &#039;FROM `test`.`pekerja`&#039; at line 1
--
-- Database: `test2`
--
...
--
-- Struktur dari tabel `refference`
--
...
--
-- AUTO_INCREMENT untuk tabel `datarumah`
--
ALTER TABLE `datarumah`
...
--
ALTER TABLE `datauser`
  ADD CONSTRAINT `fk2` FOREIGN KEY (`idRefference`) REFERENCES `refference` (`idRefference`);

--
-- Ketidakleluasaan untuk tabel `transaksi`
--
ALTER TABLE `transaksi`
  ADD CONSTRAINT `fk3` FOREIGN KEY (`idUser`) REFERENCES `datauser` (`idUser`),
  ADD CONSTRAINT `fk4` FOREIGN KEY (`idRumah`) REFERENCES `datarumah` (`idRumah`);
COMMIT;
